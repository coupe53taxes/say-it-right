...
# Debate Setup
    ...
    st.text_area("Debate Topic:", value=st.session_state.debate_topic_input, key="debate_topic_input")
    # Manually persist the topic to session state
    st.session_state["debate_topic_input"] = st.session_state.get("debate_topic_input_input", "").strip()
