...
# Debate Setup
    ...
    st.session_state.user_A_name = st.text_input("User A Name:", value=st.session_state.user_A_name)
    st.session_state.user_A_position = st.text_area("Position of User A:", value=st.session_state.user_A_position)
    st.session_state.user_B_name = st.text_input("User B Name:", value=st.session_state.user_B_name)
    st.session_state.user_B_position = st.text_area("Position of User B:", value=st.session_state.user_B_position)
